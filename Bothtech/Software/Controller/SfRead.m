...
-(NSMutableArray*)ImageArray
{
    ...
    NSMutableArray *imageArray = [[NSMutableArray alloc]initWithObjects:@"时代博晟0",@"时代博晟1",@"时代博晟2", nil];
    return imageArray;
}
...
-(NSString*)Num:(int)i
{
    NSArray *NumArray = [[NSArray alloc]initWithObjects:@"1",@"1",@"1", nil];
    return NumArray[i];
}
