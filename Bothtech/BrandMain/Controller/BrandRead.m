...
-(NSMutableArray*)ImageArray
{
    ...
    NSMutableArray *imageArray = [[NSMutableArray alloc]initWithObjects:@"p1",@"p2",@"p3", @"p4",@"p5", nil];
    return imageArray;
}
...
-(NSString*)Num:(int)i
{
    NSArray *NumArray = [[NSArray alloc]initWithObjects:@"1",@"1",@"1", @"1",@"1",nil];
    return NumArray[i];
}
