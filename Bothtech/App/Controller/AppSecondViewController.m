...
@interface AppSecondViewController ()<UIScrollViewDelegate,UIGestureRecognizerDelegate,UIAlertViewDelegate>
{
...
-(void)dealTap:(UITapGestureRecognizer *)tap
{
    ...
    AppViewController * webVC = [[AppViewController alloc] initViewController];
