...
-(NSMutableArray*)ImageArray
{
    ...
    NSMutableArray *imageArray = [[NSMutableArray alloc]initWithObjects:@"曲美家居",@"一汽丰田",@"中国发展研究基金会",@"中国建筑结构金属协会",@"中国支教联盟",@"中国铁道出版社",@"初心武道场Logo",@"果多美",@"友盟",@"咕咚",@"大成律师事务所",@"天路公考网",@"尚城同力",@"微盟",@"金龙腾",@"支付宝",@"普达财务logo",@"luosimao服务平台logo",@"初见",@"派多格",@"爱奇艺",@"百度",@"百度翻译",@"百度识图",@"快法务",@"银鹭",@"接力出版社", @"博晟科技",nil];
    return imageArray;
}
